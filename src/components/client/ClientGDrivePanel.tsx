...
export function ClientGDrivePanel({ projectId }: { projectId: string }) {
    ...
    return (
        <div className="fixed bottom-20 left-6 z-[90] pointer-events-auto" data-ui-element>
            <div className="bg-black/75 backdrop-blur-md border border-white/10 rounded-xl p-4 w-80 shadow-xl space-y-3">
